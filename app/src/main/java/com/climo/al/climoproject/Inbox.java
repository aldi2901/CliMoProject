...
public class Inbox extends Fragment {
    ...
    private List<List_Inbox> listInbox;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // listInbox = new ArrayList<>();
        //listInbox.add(new List_Inbox("Hai","Fael Antoni", R.drawable.fael));
        //listInbox.add(new List_Inbox("Hai","Roi Kiyoshi", R.drawable.roi));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // RecyclerViewAdapterInbox recyclerAdapter = new RecyclerViewAdapterInbox(getContext(),listInbox);
